package br.com.usjt.atividadeelcio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Hawk.contains("tem_cadastro")){
            if(Hawk.get("tem_cadastro")){
                // desbloquear o Login e esconder frase de cadastro
                desbloquear();

            }else{
                // bloquear login e mostrar frase de cadastro
                bloquear();

            }
        }else{
            // bloquear login e mostrar frase
            bloquear();
        }
    }
